    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap gap-2 mt-1">
        ...
        {photoPreviews.length < MAX_PHOTOS && (
          <label className="cursor-pointer flex items-center justify-center transition-colors hover:bg-black/[0.02]" style={{ width: 84, height: 84, borderRadius: "var(--bb-radius-sm)", border: "1.5px dashed rgba(43,36,32,0.28)" }}>
