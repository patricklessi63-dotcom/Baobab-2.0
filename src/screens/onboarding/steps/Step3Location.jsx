...
export default function Step3Location({ draft, update }) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <label className="text-xs font-semibold" style={{ color: "rgba(43,36,32,0.55)" }}>Pays d'origine</label>
      ...
      <label className="text-xs font-semibold mt-1" style={{ color: "rgba(43,36,32,0.55)" }}>Province</label>
      ...
      <label className="text-xs font-semibold mt-1" style={{ color: "rgba(43,36,32,0.55)" }}>Ville (Canada)</label>
